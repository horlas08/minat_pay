...
const String getAirtimePlan = '/get-airtimepin-plan';
const String getEpin = '/get-epins';
const String postWithdrawal = '/ref-withdrawal';
const String getNin = '/get-nin-plans';
const String postNin = '/nin-order';
...
const String postAirtimePin = '/airtime-pin';
